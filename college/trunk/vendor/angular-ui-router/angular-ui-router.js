 ...
 * navigation. A state describes (via the controllers / template / views properties) what
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *   (template, controllers) for the views. Even when you don't use the views object
   ...
   * If minifying your js, make sure to explictly annotate this function,
...
function $ViewProvider() {
  ...
  function $get(   $rootScope,   $templateFactory) {
    return {
      // $views.load('full.viewName', { template: ..., controllers: ..., resolve: ..., async: false, params: ... })
      /**
       * @ngdoc function
      ...
      load: function load(name, options) {
         ...
         *
         * @param {Object} event Event object.
         * @param {Object} viewConfig The views config properties (template, controllers, etc).
         *
         * @example
         *
         * <pre>
